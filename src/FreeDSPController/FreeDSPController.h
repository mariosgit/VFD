...
class FreeDSPController
{
public:
    FreeDSPController():
        encoder1(pinROT1R, pinROT1L, pinROT1C, 4, HIGH), // Bourns, STEC12E08(Alps plastik)
        encoder2(pinROT2R, pinROT2L, pinROT2C, 4, HIGH) // Bourns, STEC12E08(Alps plastik)
    {
        _the = this;
    }

    // singelton...
    static FreeDSPController *_the;
    ...
    ClickEncoder encoder1; // Bourns, STEC12E08(Alps plastik)
    ClickEncoder encoder2; // Bourns, STEC12E08(Alps plastik)
    ...
    static void encoderServiceFunc()
    {
        _the->encoder1.service();
        _the->encoder2.service();
    }
...
// cpp sucks...
FreeDSPController* FreeDSPController::_the = nullptr;
